namespace EkotaNibash.Domain
{
    public class Project
    {
        ...
        public ICollection<ProjectPayment> ProjectPayments { get; set; }
        public ICollection<ProjectDocument> ProjectDocuments { get; set; }
    }

    public class ProjectExpenseDetails
    {
        public int Id { get; set; }
    ...
    public class ProjectPayment
    {
        ...
        public Project Project { get; set; }
        public ProjectPaymentType ProjectPaymentType { get; set; }
    ...
    public class ProjectDocumentSlices : MemberDocumentSliceBase
    {
        public int Id { get; set; }
